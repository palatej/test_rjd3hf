...
a<-rjd3x11plus::x11plus(y, period=7, mul = TRUE, seas.s0="S3X15", seas.s1="S3X15", trend.horizon = 9)
a1<-rjd3x11plus::x11plus(a$decomposition$sa, period=365.25/12, mul = TRUE, seas.s0="S3X15", seas.s1="S3X15", trend.horizon = 65)
a2<-rjd3x11plus::x11plus(a1$decomposition$sa, period=365.25, mul = TRUE, trend.horizon = 367)
...
a2<-rjd3x11plus::x11plus(a1$decomposition$sa, period=365, mul = TRUE, trend.horizon = 367)
wa2<-a2$decomposition$s

plot(wa2[2000:2500], type="l")

b<-rjd3stl::stlplus(y, period=7, swindow = 21)
b1<-rjd3stl::stlplus(b$decomposition[,'sa'], period=365, swindow=3)
