...
sm_week<-function(y, seasonal="HarrisonStevens"){
  ...
  rjd3sts::add_equation(eq, "n")
  rjd3sts::add(sm, rjd3sts::locallineartrend("ll"))
  rjd3sts::add_equation(eq, "ll")
...
sm_var<-function(y, period, std_t, std_w, std_n, seasonal="HarrisonStevens"){
  ...
  eq<-rjd3sts::equation("eq")
  # create the components and add them to the model
  rjd3sts::add(sm, rjd3sts::var_locallineartrend("ll", lstd = std_t))
  rjd3sts::add_equation(eq, "ll")
  rjd3sts::add(sm, rjd3sts::var_seasonal("s", period, type=seasonal, std = std_w))
  rjd3sts::add_equation(eq, "s")
  rjd3sts::add(sm, rjd3sts::var_noise("n", std=std_n))
  rjd3sts::add_equation(eq, "n")
  rjd3sts::add(sm, eq)
  #estimate the model
